...
class SanPhamDetail extends Component {
    ...
    componentDidMount() {
      ...
      if (this.state.id){
        SanPhamChiTietService.getSPById(this.state.id).then((res) => {
        let sp = res.data;
        this.setState({ ma: sp.ma ,
        ten: sp.ten,
        idLoai: sp.selectedLoai,
        idDayDeo: sp.selectedDayDeo,
        idSP: sp.selectedSP,
        idManHinh: sp.selectedManHin,
        idMauSac: sp.selectedMau,
        idNsx: sp.selectedNsx,
        giaBan: sp.giaBan,
